...
{
    public class GuardTowerController : BaseBuildingController
    {
        ...
        private void HandleAttackEnemyUnit()
        {
            ...
            if (currentTimeToAttack >= buildingInfo.attackCooldown)
            {
                ...
                {
                    weaponManager.ShootSingleProjectile(this, transform.position, nearestOpponentUnit.transform.position);
                }
            }
        }
